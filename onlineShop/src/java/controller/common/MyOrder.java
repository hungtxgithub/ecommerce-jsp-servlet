...
public class MyOrder extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if ("addOrder".equals(action)) {
                ...
                SendMail.send(email, "Confirm purchase at Shoplazaki.vn website!", message(fullname, phone, address, email, payment1, payment2, note, total, product_id, img, title, quantity, price, sale_price, orderID, user_id));
    ...
    private String message(String fullname, String phone, String address, String email, String payment1, String payment2, String notes, float total, String[] product_id,
        ...
        if(payment2.equals("checked")){
            infoBank+="<span style='font-weight: bold;' class=\"status-order\">To continue to complete the order, please transfer to:</span><div>Bank name: Vietcombank</div><div>Account number: 0291000350547</div><div>Transfer content: "+orderID+""+userID+"</div>";
        }else{
